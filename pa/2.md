...
2. It is fine for one member of the pair to perform code commits. The commit message should indicate pair contribution. Make sure that your `README.md` lists both team members.
